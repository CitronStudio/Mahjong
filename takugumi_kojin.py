...
while True:
    ...
    while True:     
        ...
        # loop_countが一定数を超えたら、もう一度全て最初からやり直す。loop数は挙動を見ながら変えてもよい
        if loop_count > 500:
            break
            
    # game_count戦目まで作成が成功した場合、プログラムを終了する
    if i == game_count:
        break
